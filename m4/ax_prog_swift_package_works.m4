...
EOF
        ...
        AS_IF([AC_TRY_COMMAND($SWIFT_PACKAGE dump-package --input "$ax_tmpdir_swift/swift_package/Package.swift") > "$ax_tmpdir_swift/swift_package_info.json"], [
            ac_swift_package_info=`cat "$ax_tmpdir_swift/swift_package_info.json"`
